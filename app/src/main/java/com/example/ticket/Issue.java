...
public class Issue extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //data123 = data123.replaceAll(", $", " ");

        //Toast.makeText(getApplicationContext(), "Issuring Ticket"+data123, Toast.LENGTH_LONG).show();
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    sendmail(email, xcon);
                    Intent i = new Intent(Issue.this, MainActivity.class);
